                ...
                <div key={testimonial.id} style={{ padding: '0 12px' }}>
                  <div className="single-testimonial">
                    ...
                    <div className="customar-info">
                      <div className="customar-img"><img src={testimonial.image} alt="tc" width="60" height="60"/></div>
                      <div className="customar-title"><h5>{testimonial.name}</h5><span className="title">{testimonial.title}</span></div>
                    </div>
