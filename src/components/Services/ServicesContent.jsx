        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-4 mb-lg-0">
              <div className="single-pricing wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                <div className="pricing-badge text-center">
                  ...
                  <div className="pricing-btn">
                    <a className="btn" href="#" style={{background: 'transparent', border: '1px solid rgba(255,255,255,.3)', color: '#fff', borderRadius: '6px', fontWeight: 600, textDecoration: 'none'}}>Discover More</a>
                  </div>
                </div>
                <div className="pricing-content" style={{padding: '40px', textAlign: 'center'}}>
                  <ul className="pricing-list" style={{listStyle: 'none', padding: 0, margin: 0}}>
                    <li style={{marginBottom: '12px', color: '#666', fontSize: '16px'}}>Key Words Optimized</li>
                    <li style={{marginBottom: '12px', color: '#666', fontSize: '16px'}}>Top 10 Ranking Guarantee</li>
                    <li style={{marginBottom: '12px', color: '#666', fontSize: '16px'}}>Weekly Reporting</li>
                    <li style={{marginBottom: '12px', color: '#666', fontSize: '16px'}}>Key Words Optimized</li>
                    <li style={{marginBottom: '12px', color: '#666', fontSize: '16px'}}>Top 10 Ranking Guarantee</li>
                    <li style={{color: '#666', fontSize: '16px'}}>Unlimited users</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-4 mb-lg-0">
              <div className="single-pricing popular wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                <div className="pricing-badge text-center" style={{background: 'var(--thm-teal)'}}>
                  <span className="title" style={{color: '#fff'}}>Popular</span>
                  <div className="pricing-price">
                    <span className="currency" style={{color: '#fff'}}>$</span>
                    <h3 className="price">210<span style={{color: 'rgba(255,255,255,.8)'}}>/Per Month</span></h3>
                  </div>
                  <div className="pricing-btn">
                    <a className="btn" href="#" style={{background: '#fff', color: 'var(--thm-teal)', borderRadius: '6px', fontWeight: 600, textDecoration: 'none'}}>Discover More</a>
                  </div>
                </div>
                <div className="pricing-content" style={{padding: '40px', textAlign: 'center'}}>
                  <ul className="pricing-list" style={{listStyle: 'none', padding: 0, margin: 0}}>
